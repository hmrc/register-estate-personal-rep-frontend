  ...
  .settings(
    ...
    Concat.groups := Seq(
      "javascripts/registerestatepersonalrepfrontend-app.js" ->
        group(Seq("javascripts/show-hide-content.js", "javascripts/registerestatepersonalrepfrontend.js"))
    ),
    ...
    includeFilter in uglify := GlobFilter("registerestatepersonalrepfrontend-*.js")
  )
