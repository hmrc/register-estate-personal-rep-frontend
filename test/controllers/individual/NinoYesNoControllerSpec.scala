...
import pages.individual.{NamePage, NinoYesNoPage}
import play.api.data.Form
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import views.html.individual.NinoYesNoView

class NinoYesNoControllerSpec extends SpecBase {

  lazy val ninoYesNoRoute: String = routes.NinoYesNoController.onPageLoad(NormalMode).url
  ...
  "NinoYesNo Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val request = FakeRequest(GET, ninoYesNoRoute)
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = baseAnswers
        .set(NinoYesNoPage, validAnswer).success.value
    ...
    "redirect to next page when valid data is submitted" in {
      ...
      val request =
        FakeRequest(POST, ninoYesNoRoute)
