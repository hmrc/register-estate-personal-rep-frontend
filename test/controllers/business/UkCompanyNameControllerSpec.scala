...
import pages.business.UkCompanyNamePage
...
class UkCompanyNameControllerSpec extends SpecBase with MockitoSugar {

  override def onwardRoute = Call("GET", "/foo")

  val formProvider = new StringFormProvider()
  val form = formProvider.withPrefix("business.ukCompany.name", 105)
  val name = "Name"

  lazy val nameRoute = routes.UkCompanyNameController.onPageLoad(NormalMode).url
  ...
  "Name Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[UkCompanyNameView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val ua = emptyUserAnswers.set(UkCompanyNamePage, name)
