...
class IdCardFormProviderSpec extends PassportOrIdCardFieldBehaviours with FakeApp {

  val prefix: String = "individual.idCard"

  val form: Form[IdCard] = new IdCardFormProvider(frontendAppConfig).withPrefix(prefix)
